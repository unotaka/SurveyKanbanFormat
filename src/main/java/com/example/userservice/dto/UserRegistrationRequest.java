 ...
 * Carries data from the client or controller to the service layer.
 */
public class UserRegistrationRequest {
    ...
    // Default constructor for deserialization frameworks (e.g., JSON parsers)
    ...
    public String toString() {
        return "UserRegistrationRequest{" +
               "username='" + username + '\'' +
               ", email='" + email + '\'' + // Password is sensitive, do not include in toString
               '}';
    }
}
